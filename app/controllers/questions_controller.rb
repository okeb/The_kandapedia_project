class QuestionsController < ApplicationController
  ...
  def show
    ...
    impressionist(@question, I18n.t('visionnage_de_la_question_title', title: @question.title))
  end
  ...
  def add_awesome
    if (current_account.voted_up_on? @question, 
                                     vote_scope: :appreciation) && (current_account.vote_weight_on(@question, 
                                                                                                   vote_scope: :appreciation) === 3)
      remove_appreciation
  ...
  def add_wrong
    decrement_likes_counter(@question) if current_account.voted_up_on? @question, vote_scope: :appreciation
    if (current_account.voted_down_on? @question, 
                                       vote_scope: :appreciation) && (current_account.vote_weight_on(@question, 
                                                                                                     vote_scope: :appreciation) === 1)
      remove_appreciation
    else
  ...
  def user_authenticate
    @current_user = current_account if rodauth.logged_in?
  end
